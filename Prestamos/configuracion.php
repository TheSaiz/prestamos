        ...
        <div class="max-w-7xl mx-auto px-4 py-8">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                <div class="flex border-b overflow-x-auto">
                    ...
                    <button onclick="showTab('faq')" id="tab-faq"class="px-6 py-4 font-semibold transition whitespace-nowrap text-gray-600 hover:bg-gray-50">Preguntas Frecuentes</button><button onclick="showTab('colors')" id="tab-colors" class="px-6 py-4 font-semibold transition whitespace-nowrap text-gray-600 hover:bg-gray-50">Colores</button>
                </div>
...
<div id="section-faq" class="tab-content hidden">
    ...
    <div id="faq-container" class="space-y-8">
        <?php if (isset($config['faq'])): ?>
            ...
            <div class="p-6 bg-gray-50 rounded-lg space-y-4 border">
                <h3 class="font-bold text-lg">Pregunta <?php echo $index + 1; ?></h3>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Pregunta</label>
                    <input type="text" id="faq-question-<?php echo $index; ?>"
                ...
                <div>
                    ...
                    <textarea id="faq-answer-<?php echo $index; ?>" rows="4"
                              class="w-full px-4 py-2 border rounded-lg"><?php echo htmlspecialchars($faq['respuesta']); ?></textarea>
                </div>

                <button type="button" onclick="deleteFAQ(<?php echo $index; ?>)"
    ...
    function saveConfig() {
        let newConfig = {
            hero: {
                ...
                cta: document.getElementById('hero-cta') ? document.getElementById('hero-cta').value : originalConfig.hero.cta
            },
            benefits: [],
            products: [],
            contact: {
    ...
    function addFAQ() {
        ...
        block.innerHTML = `
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Respuesta</label>
                <textarea id="faq-answer-${index}" rows="4"
