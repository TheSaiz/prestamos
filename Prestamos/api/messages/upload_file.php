...
$extensiones_permitidas = ['pdf', 'png', 'jpg', 'jpeg', 'webp', 'xls', 'xlsx'];
$extension = strtolower(pathinfo($archivo['name'], PATHINFO_EXTENSION));

if (!in_array($extension, $extensiones_permitidas)) {
    http_response_code(400);
    echo json_encode(["success" => false, "message" => "Tipo de archivo no permitido. Solo: PDF, PNG, JPG, JPEG, WEBP, XLS, XLSX"]);
    exit;
}
