...
// Obtener chat activo (el primero si existe)
...
<head>
    ...
    <title>Chat - Panel de Asesor</title>
...
<body class="bg-gray-50">
    ...
    <div class="flex h-full">
        ...
        <div class="w-80 bg-white border-r border-gray-200 flex flex-col">
            ...
            <div class="p-4 border-b border-gray-200">
                ...
                <div class="flex gap-2 mt-3 text-xs">
                    <button class="px-3 py-1.5 bg-blue-50 text-blue-600 rounded-lg font-semibold">New</button>
                    <button class="px-3 py-1.5 text-gray-600 hover:bg-gray-50 rounded-lg">In progress</button>
                    <button class="px-3 py-1.5 text-gray-600 hover:bg-gray-50 rounded-lg">Waiting</button>
                    <button class="px-3 py-1.5 text-gray-600 hover:bg-gray-50 rounded-lg">Completed</button>
                </div>
            </div>
        ...
        <div class="flex-1 flex flex-col bg-gray-50">
            ...
            <div class="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2 text-xs text-gray-500">
                            <span class="material-icons-outlined" style="font-size: 14px;">circle</span>
                            <span><?php echo ucfirst($chat_activo['estado']); ?></span>
                            <span>•</span>
                ...
                <div class="flex items-center gap-2">
                    <button onclick="toggleProfile()" class="px-4 py-2 text-sm text-blue-600 hover:bg-blue-50 rounded-lg transition flex items-center gap-2">
                ...
                <div class="flex items-end gap-3">
                    <div class="flex-1 relative">
                        <textarea id="message-input" rows="1" placeholder="Type your message here..."
                                  class="w-full px-4 py-3 pr-32 bg-gray-50 border border-gray-200 rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
                                  style="max-height: 120px;"></textarea>
                        <div class="absolute right-3 bottom-3 flex items-center gap-2">
                            <button class="text-gray-400 hover:text-gray-600">
                                <span class="material-icons-outlined text-lg">attach_file</span>
                            </button>
                            <button class="text-gray-400 hover:text-gray-600">
                                <span class="material-icons-outlined text-lg">image</span>
                            </button>
                            <button class="text-gray-400 hover:text-gray-600">
                                <span class="material-icons-outlined text-lg">sentiment_satisfied_alt</span>
                            </button>
                        </div>
                    </div>
        ...
        <div id="profile-panel" class="w-80 bg-white border-l border-gray-200 overflow-y-auto hidden">
            <div class="p-6">
                ...
                <div class="space-y-4 mb-6">
                    ...
                    <div class="pb-4 border-b border-gray-100">
                        <label class="text-xs text-gray-500 uppercase font-semibold">Fecha inicio</label>
                        <p class="text-sm text-gray-800 mt-1"><?php echo date('d/m/Y H:i', strtotime($chat_activo['fecha_inicio'])); ?></p>
                    </div>
                </div>
        ...
        <div class="flex-1 flex items-center justify-center bg-gray-50">
            <div class="text-center">
                ...
                <p class="text-sm text-gray-500">Elige una conversación del panel izquierdo</p>
            </div>
        </div>
        <?php endif; ?>
    ...
    <div id="notificaciones-container" class="fixed bottom-6 right-6 z-50 space-y-3"></div>
    ...
    <script>
        ...
        setInterval(async () => {
            try {
                ...
                if (data.success && data.data.chats.length > 0) {
                    showNewChatNotification(data.data.chats[0]);
                }
            } catch (error) {
                console.error('Error:', error);
            }
        ...
        function showNewChatNotification(chat) {
            ...
            notif.className = 'bg-white shadow-2xl rounded-xl p-4 border-l-4 border-blue-600 max-w-sm animate-slide-in';
            notif.innerHTML = `
                <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xs text-gray-600 mt-1">${chat.cliente_nombre} - ${chat.departamento_nombre}</p>
        ...
        async function acceptChat(chatId) {
            try {
                const response = await fetch('api/asesores/accept_chat.php', {
                    ...
                    body: JSON.stringify({ chat_id: chatId, asesor_id: asesorId })
                });
