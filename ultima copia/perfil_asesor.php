...
<body>
    ...
    <aside class="bg-white shadow-lg">
        <div class="p-6 border-b">
            <h1 class="text-2xl font-bold text-gray-800">Préstamo Líder</h1>
            <p class="text-sm text-gray-500 mt-1">Panel de <?php echo ucfirst($usuario['rol']); ?></p>
        </div>

        <nav class="p-4">
            <?php if ($usuario['rol'] === 'admin'): ?>
                <a href="dashboard.php" class="flex items-center gap-3 p-3 rounded-lg hover:bg-blue-50 text-gray-700 mb-2">
                    <span class="material-icons-outlined">dashboard</span>
                    <span>Dashboard</span>
                </a>
            <?php endif; ?>
            
            <?php if ($usuario['rol'] === 'asesor'): ?>
                <a href="panel_asesor.php" class="flex items-center gap-3 p-3 rounded-lg hover:bg-blue-50 text-gray-700 mb-2">
                    <span class="material-icons-outlined">chat</span>
                    <span>Mis Chats</span>
                </a>
            <?php endif; ?>

            <a href="perfil_asesor.php" class="flex items-center gap-3 p-3 rounded-lg bg-blue-50 text-blue-600 mb-2">
                <span class="material-icons-outlined">person</span>
                <span>Mi Perfil</span>
            </a>

            <a href="logout.php" class="flex items-center gap-3 p-3 rounded-lg hover:bg-red-50 text-red-600 mt-4">
