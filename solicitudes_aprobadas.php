...
try {
    ...
    $rows = [];
    error_log("Error en solicitudes_aprobadas: " . $e->getMessage());
}
...
<div class="page-content">
    ...
    <div class="flex justify-between items-center flex-wrap gap-4">
      <div>
        <div class="flex items-center gap-2 mb-2">
          ...
          <h1 class="text-3xl font-bold text-gray-800">Solicitudes Aprobadas</h1>
        </div>
        <p class="text-gray-600">Historial de solicitudes aprobadas</p>
      </div>
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    <div class="stat-card">
      ...
      <div class="text-3xl font-bold text-green-600 mb-1"><?php echo $total; ?></div>
      <div class="text-sm text-gray-600">
        <?php 
        switch($filtro) {
          case 'hoy': echo 'Aprobadas hoy'; break;
          case 'ayer': echo 'Aprobadas ayer'; break;
          case 'semana': echo 'Últimos 7 días'; break;
          case 'mes': echo 'Últimos 30 días'; break;
          default: echo 'Total de aprobadas';
        }
        ?>
      </div>
    </div>
      ...
      <table class="w-full text-sm">
        <thead class="bg-gray-50 border-b">
          <tr>
            ...
            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Fecha Aprobación</th>
          ...
          <?php if (empty($rows)): ?>
            <tr>
              <td colspan="6" class="text-center py-12">
                <span class="material-icons-outlined text-gray-300" style="font-size: 4rem;">check_circle</span>
                <div class="text-gray-500 mt-3">No hay solicitudes aprobadas
                  <?php 
                  if ($filtro !== 'todas') {
